...
## 8) 필수 플랫폼 계정 준비 (GitHub · Docker Hub · AWS)

### 확인 결과
- 이 문서에는 현재 GitHub, Docker Hub, AWS의 **가입 + 2단계 인증(2FA/MFA) 설정 절차**가 별도로 정리되어 있지 않습니다.
- 아래에 실습 전 필수 준비 절차를 추가합니다.

### 8-1) GitHub 가입 및 2FA 설정
...
### 8-3) AWS 가입 및 MFA 설정
1. https://aws.amazon.com 접속 → **Create an AWS Account**
